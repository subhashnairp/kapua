...
public class DatastoreChannel {
    ...
    private void init(String account, String clientId, String channel) throws InvalidChannelException {

        // Must be not null and not multilevel wild card
        if (account == null || MULTI_LEVEL_WCARD.equals(account))
            throw new InvalidChannelException("Invalid account: " + account);

        this.account = account;

        // Must be not null and not multilevel wild card
        if (clientId == null || MULTI_LEVEL_WCARD.equals(clientId))
            throw new InvalidChannelException("Invalid client id: " + clientId);
     ...
     */
    public DatastoreChannel(String account, String clientId, List<String> channelParts) throws InvalidChannelException {
     ...
     * @throws InvalidChannelException
     */
    public DatastoreChannel(String account, String clientId, String channel) throws InvalidChannelException {
     ...
     * @throws InvalidChannelException
     */
    public DatastoreChannel(String fullName) throws InvalidChannelException {

        // Must be not null and not multilevel wild card
        if (fullName == null)
            throw new InvalidChannelException("Invalid channel: " + fullName);

        String[] parts = fullName.split(Pattern.quote(TOPIC_SEPARATOR));
        if (parts.length < MIN_PARTS)
            throw new InvalidChannelException(String.format("Invalid channel: less than %d parts found.", MIN_PARTS));
